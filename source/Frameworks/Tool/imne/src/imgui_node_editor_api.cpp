...
void ax::NodeEditor::SetNodeFlags(NodeId id, ImneObjFlags flags, bool state)
{
  s_Editor->GetNodeBuilder().SetNodeFlags(id, flags, state);
}

void ax::NodeEditor::SetPinFlags(PinId id, PinKind kind, ImneObjFlags flags, bool state)
{
  s_Editor->GetNodeBuilder().SetPinFlags(id, kind, flags, state);
}

void ax::NodeEditor::SetCurrentNodeFlags(ImneObjFlags flags, bool state)
{
  s_Editor->GetNodeBuilder().SetCurrentNodeFlags(flags, state);
}

void ax::NodeEditor::SetCurrentPinFlags(ImneObjFlags flags, bool state)
{
  s_Editor->GetNodeBuilder().SetCurrentPinFlags(flags, state);
}

void ax::NodeEditor::SetPinInteraction(ImneObjFlags flags)
{
...
void ax::NodeEditor::PushClipRect(const ImVec2& min, const ImVec2& max) 
{
  s_Editor->PushClipRect(min, max);
}

void ax::NodeEditor::PopClipRect() 
{
  s_Editor->PopClipRect();
}
...
ImDrawList* ax::NodeEditor::GetUserBackgroundDrawList()
{
  return s_Editor->GetNodeBuilder().GetUserBackgroundDrawList();
}
...
ImVec2 ax::NodeEditor::GetLastNodeDrawMin()
{
  return s_Editor->GetLastNodeDrawArea().Min;
}

ImVec2 ax::NodeEditor::GetLastNodeDrawMax()
{
  return s_Editor->GetLastNodeDrawArea().Max;
}

ImVec2 ax::NodeEditor::GetLastNodeMin()
{
  return s_Editor->GetLastNodeBounds().Min;
}

ImVec2 ax::NodeEditor::GetLastNodeMax()
{
  return s_Editor->GetLastNodeBounds().Max;
}
