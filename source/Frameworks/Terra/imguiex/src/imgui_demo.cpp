...
static void ShowDemoWindowWidgets()
{
  ...
  if (ImGui::TreeNode("Basic"))
  {
...

    {
      ...
      if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) // Delay best used on items that highlight on hover, so
                                                               // this not a great example!
  ...
  if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
  {
    ...
    if (ImGui::TreeNode("Keyboard, Gamepad & Navigation State"))
    {
      ...
      // Draw an arbitrary US keyboard layout to visualize translated keys
      {
        ...
        // While not strictly necessary, here IsItemVisible() is used to avoid rendering these shapes when they are out
        // of view.
        ...
        if (ImGui::IsItemVisible())
        {
          ...
          for (int n = 0; n < IM_ARRAYSIZE(keys_to_display); n++)
          {
            ...
            draw_list->AddRect(face_min, face_max, IM_COL32(193, 193, 193, 255), key_face_rounding, ImDrawFlags_None,
                               2.0f);
...
void ShowExampleAppDockSpace(bool* p_open)
{
  ...
  // your code!) TL;DR; this demo is more complicated than what you would normally use. If we removed all the options we
  // are showcasing, this demo would become:
