...
#define IMGUI_NODE_EDITOR_ENUM_FLAGS(Enum)                                                                                          \
...
{
  ImneObjFlags_None = 0,
  ImneObjFlags_ExplicitInteractions = 1 << 0,
  ImneObjFlags_IsActive             = 1 << 1,
  ImneObjFlags_IsDoubleClicked      = 1 << 2,
  ImneObjFlags_IsClicked            = 1 << 3,
  ImneObjFlags_IsHovered            = 1 << 4,
};

IMGUI_NODE_EDITOR_ENUM_FLAGS(ImneObjFlags)

void SetNodeFlags(NodeId id, ImneObjFlags, bool state);
void SetPinFlags(PinId id, PinKind kind, ImneObjFlags, bool state);
...
ImDrawList* GetUserBackgroundDrawList();
...
ImVec2 GetLastNodeDrawMin();
ImVec2 GetLastNodeDrawMax();

ImVec2 GetLastNodeMin();
ImVec2 GetLastNodeMax();
