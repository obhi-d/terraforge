...
void declBufferOutput(std::string& opaque, DescriptorList& dl, OptionList& ol, int32_t& binding, ShaderBuilder& sb);
void fillScalarDisabled(Pipeline const&, ParameterMeta const& pm, Parameter const& sv, ubyte_t* data);
